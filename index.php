...
<html>
    <head>
        ...
        <title>SJD LOS CAbos international information</title>
    ...
    <body>
        ...
        <div class="primary-header hidden">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-5">
                        <div class="mail">
                            <i class="fa fa-envelope"></i>
                            <span>Email us at : <a class="email-us" href="mailto:info@sjdlos.com">info@sjdlos.com</a></span>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-7">
                        <div class="social-wrap clearfix">
                            <a href="#" class="request">CALL US NOW: 987654321</a>
                            <ul class="social">
                                <li>
        ...
        <nav class="navbar navbar-inverse header-nav hidden">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="#"><img src="assets\images\gap_logo.jpg" alt="logo" class="navbar-brand"/></a></div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="heading">
                                    ...
                                    <h2>Passenger Services at SJD Airport 2017</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="http://www.insideloscabos.com"><img src="assets\images\Airport Transportation Transfers Shuttle & Taxis.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="?page=sjd_airport_map"><img src="assets\images\Airport Information.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="?page=sjd_flights"><img src="assets\images\Fight Information at Cabo Airport.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="?page=airport_authority"><img src="assets\images\SJD Airport Authority Information.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="#?page=hotels_in_san_jose_cabo"><img src="assets\images\Lodging in cabo Area.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="?page=sjd_luggage"><img src="assets\images\Documented luggage.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                        ...
                                        <div class="slides-tab zoom">
                                           <!--<figure>
                                            ...
                                            <div class="slides-text">
                                                ...
                                                <div>
                                                 <a href="?page=passengers"><img src="assets\images\Forbidden Permited security.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                    ...
                                    <div class="col-md-6 col-sm-6">                                        
                                        <div class="slides-tab zoom">
                                            <!--<figure>
                                                <a href="#"><img src="assets/images/plane.jpg" alt="" class="img-responsive"></a>
                                            </figure>-->
                                            <div class="slides-text">
                                                <h4><a href="#">Conditions</a></h4>
                                                <div>
                                                 <img src="assets\images\Conditions.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                    ...
                                    <div class="col-md-6 col-sm-6">                                        
                                        <div class="slides-tab zoom">
                                            <!--<figure>
                                                <a href="#"><img src="assets/images/documentation.jpg" alt="" class="img-responsive"></a>
                                            </figure>-->
                                            <div class="slides-text">
                                                <h4><a href="?page=sjd_customs">Custom Information</a></h4>
                                                <div>
                                                 <a href="?page=sjd_customs"><img src="assets\images\Custom Information.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                                    ...
                                    <div class="col-md-6 col-sm-6">                                        
                                        <div class="slides-tab zoom">
                                            <!--<figure>
                                                <a href="#"><img src="assets/images/customere.jpg" alt="" class="img-responsive"></a>
                                            </figure>-->
                                            <div class="slides-text">
                                                <h4><a href="?page=sjd_airport_services">Airport Services</a></h4>
                                                <div>
                                                 <a href="?page=sjd_airport_services"><img src="assets\images\Airport Service.jpg" alt="" class="img-responsive" style="width: 100px;height: 100px;"> </a> 
                            ...
                            <div class="col-md-6">
                                ...
                                switch($page)
                                {
                                case 'sjd_airport_map':  
                                    include "sjd_airport_map.php";  break;
                               case 'sjd_flights':  
                                    include "sjd_flights.php";  break;
                                case 'airport_authority':  
                                    include "airport_authority.php";  break;
                                case 'hotels_in_san_jose_cabo':  
                                    include "hotels_in_san_jose_cabo.php";  break;
                               case 'sjd_luggage':
                                    include "sjd_luggage.php" ; break;
                               case 'passengers':
                                    include "passengers.php" ; break; 
                               case 'sjd_condition1':
                                    include "sjd_condition1.php" ; break;
                               case 'sjd_condition2':
                                    include "sjd_condition2.php" ; break;
                               case 'sjd_condition3':
                                    include "sjd_condition3.php" ; break;
                               case 'sjd_customs':
                                    include "sjd_customs.php" ; break;
                               case 'sjd_airport_services':
                                    include "sjd_airport_services.php" ; break;
                ...
                <footer>
                    <div class="row custom-row">
                        <div class="col-xs-12">
                            <div class="col-md-7">
                                <div class="copyright">
                                    <span>Non official Informative website about SJD Los Cabos Mexico International Airport Information</span>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-5 no-wrap-mobile">
